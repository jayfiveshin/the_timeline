...
describe UsersController do
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      it "should have a welcome message" do
        post :create, :user => @attr
        flash[:success].should =~ /welcome to timeline/i
      end
  ...
  describe "DELETE 'destroy'" do
    ...
    end #of "as a non-signed-in user"
    ...
    describe "as a non-admin user" do
      ...
      it "should not be able to see delete links" do
        #does this test belong here?
        #response.should_not have_selector("a", :data_method => "delete")
      end
    end #of "as a non-admin user"
    ...
    describe "as an admin user" do
      ...
      it "should be able to see delete links" do
        #does this test belong here?
        #response.should have_selector("a", :data_method => "delete")
      end
      
    end #of "as an admin user"
